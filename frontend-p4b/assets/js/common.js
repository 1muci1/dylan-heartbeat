...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v67-p4b";
  const SW_CACHE_NAME = "xinban-shell-v67-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v67";
  windowRef.XINBAN_BUILD = "v67-p4b";
