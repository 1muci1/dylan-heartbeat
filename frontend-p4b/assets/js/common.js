...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v68-p4b";
  const SW_CACHE_NAME = "xinban-shell-v68-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v68";
  windowRef.XINBAN_BUILD = "v68-p4b";
