...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v61-p4b";
  const SW_CACHE_NAME = "xinban-shell-v61-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v61";
  windowRef.XINBAN_BUILD = "v61-p4b";
