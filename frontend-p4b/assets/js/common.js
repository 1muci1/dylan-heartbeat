...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v70-p4b";
  const SW_CACHE_NAME = "xinban-shell-v70-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v70";
  windowRef.XINBAN_BUILD = "v70-p4b";
