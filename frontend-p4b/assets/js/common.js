...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v69-p4b";
  const SW_CACHE_NAME = "xinban-shell-v69-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v69";
  windowRef.XINBAN_BUILD = "v69-p4b";
