...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v65-p4b";
  const SW_CACHE_NAME = "xinban-shell-v65-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v65";
  windowRef.XINBAN_BUILD = "v65-p4b";
