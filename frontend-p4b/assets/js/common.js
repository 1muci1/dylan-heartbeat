...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v71-p4b";
  const SW_CACHE_NAME = "xinban-shell-v71-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v71";
  windowRef.XINBAN_BUILD = "v71-p4b";
