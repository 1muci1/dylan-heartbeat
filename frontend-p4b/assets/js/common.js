...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v77-p4b";
  const SW_CACHE_NAME = "xinban-shell-v77-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v77";
  windowRef.XINBAN_BUILD = "v77-p4b";
