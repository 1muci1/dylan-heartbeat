...
((windowRef, documentRef, navigatorRef) => {
  const APP_VERSION = "v74-p4b";
  const SW_CACHE_NAME = "xinban-shell-v74-p4b";
  const CONTROLLER_REFRESH_GUARD = "p4b-sw-controller-refresh-v74";
  windowRef.XINBAN_BUILD = "v74-p4b";
