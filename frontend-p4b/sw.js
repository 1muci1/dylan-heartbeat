const CACHE_NAME = "xinban-shell-v44-p4b";
...
const APP_SHELL = [
  ...
  "./assets/css/home.css",
  "./assets/css/chat.css?v=v44-p4b",
  "./assets/css/dashboard.css",
  "./assets/css/settings.css",
  "/shared/provider-config-panel.css",
  "./assets/css/memory.css",
  "./assets/css/stickers.css?v=v44-p4b",
  ...
  "./assets/js/message.js?v=v44-p4b",
  "./assets/js/provider.js",
  "./assets/js/api.js?v=v44-p4b",
  "./assets/js/common.js?v=v44-p4b",
  "./assets/js/sessions.js",
  "./assets/js/stickers.js?v=v44-p4b",
  "./assets/js/sticker-manager.js?v=v44-p4b",
  "./assets/js/home.js",
  ...
  "./assets/js/chat.js?v=v44-p4b",
  "./assets/js/dashboard.js",
  "./assets/js/settings.js?v=v44-p4b",
  "./assets/js/memory.js",
