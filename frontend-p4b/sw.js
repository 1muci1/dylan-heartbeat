const CACHE_NAME = "xinban-shell-v63-p4b";
const BUILD_REVISION = "v63-p4b-computed-theme-audit";
...
const APP_SHELL = [
  ...
  "./manifest.json",
  "./assets/css/common.css?v=v63-p4b",
  "./assets/css/theme.css?v=v63-p4b",
  "./assets/css/theme-workshop.css?v=v63-p4b",
  "./assets/css/home.css",
  "./assets/css/chat.css?v=v63-p4b",
  "./assets/css/dashboard.css",
  "./assets/css/settings.css",
  "/shared/provider-config-panel.css",
  "./assets/css/memory.css",
  "./assets/css/stickers.css?v=v63-p4b",
  ...
  "./assets/js/message.js?v=v63-p4b",
  "./assets/js/provider.js",
  "./assets/js/api.js?v=v63-p4b",
  "./assets/js/common.js?v=v63-p4b",
  "./assets/js/theme-store.js?v=v63-p4b",
  "./assets/js/tavern-theme-adapter.js?v=v63-p4b",
  "./assets/js/theme-gateway.js?v=v63-p4b",
  "./assets/js/theme-workshop.js?v=v63-p4b",
  "./assets/js/sessions.js",
  "./assets/js/stickers.js?v=v63-p4b",
  "./assets/js/sticker-manager.js?v=v63-p4b",
  "./assets/js/home.js",
  ...
  "./assets/js/chat.js?v=v63-p4b",
  "./assets/js/dashboard.js",
  "./assets/js/settings.js?v=v63-p4b",
  "./assets/js/memory.js",
