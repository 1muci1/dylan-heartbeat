...
test("Service Worker controller change refreshes only once per v41 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v41"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v41-p4b");
});
