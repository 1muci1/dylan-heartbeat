...
test("Service Worker controller change refreshes only once per v40 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v40"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v40-p4b");
});
