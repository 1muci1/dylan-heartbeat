...
test("Service Worker controller change refreshes only once per v54 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v54"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v54-p4b");
});
