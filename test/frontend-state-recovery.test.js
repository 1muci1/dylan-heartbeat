...
test("Service Worker controller change refreshes only once per v44 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v44"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v44-p4b");
});
