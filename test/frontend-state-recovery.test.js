...
test("Service Worker controller change refreshes only once per v53 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v53"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v53-p4b");
});
