...
test("Service Worker controller change refreshes only once per v50 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v50"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v50-p4b");
});
