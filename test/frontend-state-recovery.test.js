...
test("Service Worker controller change refreshes only once per v55 tab session", async () => {
  ...
  assert.equal(session.get("p4b-sw-controller-refresh-v55"), "1");
  assert.equal(windowRef.XINBAN_BUILD, "v55-p4b");
});
