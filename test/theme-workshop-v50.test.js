...
test("v53 ThemeStore loads and migrates the default theme without old localStorage", () => {
...
test("theme workshop is linked, live-preview driven, and every main page loads theme variables", () => {
  ...
  for (const page of ["index.html", "chat.html", "dashboard.html", "settings.html", "memory.html", "stickers.html"]) {
    ...
    assert.match(html, /assets\/css\/theme\.css\?v=v53-p4b/, page);
    assert.match(html, /assets\/js\/theme-store\.js\?v=v53-p4b/, page);
  }
});
